...
###Evaluate CWQ
/home/zhengu9/miniconda3/envs/gnn-rag/bin/python -m gnn.main ReaRev --entity_dim 50 --num_epoch 1 --batch_size 8 --eval_every 1 --data_folder data/CWQ/ --lm sbert --num_iter 2 --num_ins 3 --num_gnn 3 --relation_word_emb True --experiment_name ReaRev_CWQ_small --name cwq --max_train 10